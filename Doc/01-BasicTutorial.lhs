...
Now let's add a few users. We'll give each user a correctly salted and hashed password too. (Don't forget to use current best practices if you want to store passwords in your database!)
